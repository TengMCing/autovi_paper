...
measuring how prominently a specific set of visual patterns appears in
an image. This can be computed for a training set of data, and plots,
where the generating distributions are specified.

In the context of regression model diagnostics, it describes the clarity
of visual patterns on a diagnostic plot that may indicate model
violations. This concept can be categorized as weak, moderate, or
strong. However, in our study, we treat it as a continuous positive real
...
VSS is defined as an estimate of a distance measure that quantifies the
disparity between the residual distribution of a fitted classical normal
linear regression model and a reference distribution, and more details
can be found in \citet{li2024automated}. This measure is based on the
...
This distance measure requires knowledge of the true residual
distribution, which is typically unknown. Therefore, a computer vision
model was used for estimating the residual distribution \citep[see][ for
more details]{li2024automated}.
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{autovi_paper_submission1_files/figure-pdf/fig-three-examples-1.pdf}
...
\includegraphics[width=0.6\linewidth,height=\textheight,keepaspectratio]{autovi_paper_submission1_files/figure-pdf/fig-plot-pair-1.pdf}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{autovi_paper_submission1_files/figure-pdf/fig-summary-plot-1.pdf}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{autovi_paper_submission1_files/figure-pdf/fig-autovi-diag-1.png}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{autovi_paper_submission1_files/figure-pdf/fig-autovi-web-setup-1.png}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{autovi_paper_submission1_files/figure-pdf/fig-autovi-web-lineup-1.png}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{autovi_paper_submission1_files/figure-pdf/fig-autovi-web-distributions-1.png}
