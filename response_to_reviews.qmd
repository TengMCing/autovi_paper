...
We thank the reviewers for their comments (colored in ${\color{violet}\text{purple}}$ below). We have addressed it as below (in black). We also submit the difference between the previously submitted document and the revised version produced via `latexdiff`.
