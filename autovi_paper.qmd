...
The remainder of this paper is structured as follows: @sec-vss-desc introduces the definition and computation of visual signal strength. @sec-null-and-boot-desc expands on the computation of the null and bootstrapped residuals.  @sec-autovi provides a detailed documentation of the `autovi` package, including its usage and infrastructure. @sec-autovi-web focuses on the `autovi.web` interface, describing its design and usage, along with illustrative examples. Finally, @sec-autovi-conclusion presents the main conclusions of this work.
