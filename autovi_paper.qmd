---
title: "Software for Automated Residual Plot Assessment: autovi and autovi.web"
subtitle: ANZJS Quarto Template
format:
  quarto-anzjs-pdf:
    keep-tex: true  
    shorttitle: "Software for Automated Residual Plot Assessment"
    double-space: true
    line-numbers: true
...
The `autovi` package is available on CRAN. It is actively developed and maintained, with the latest updates accessible on GitHub at [https://github.com/TengMCing/autovi](https://github.com/TengMCing/autovi). The code discussed in this paper is based on `autovi` version 0.4.1.
...
```{r fig-plot-pair, echo = TRUE, fig.height=3, fig.width=4, fig.cap="True plot alongside one null plot, for quick comparison."}
checker$plot_pair()
```
