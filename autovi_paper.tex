...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{AUTO\_GLM\_VI }\OtherTok{\textless{}{-}} \FunctionTok{new\_class}\NormalTok{(AUTO\_VI, }\AttributeTok{class\_name =} \StringTok{"AUTO\_GLM\_VI"}\NormalTok{)}
\FunctionTok{register\_method}\NormalTok{(}
\NormalTok{  AUTO\_GLM\_VI,}
...
\NormalTok{  \}}
\NormalTok{)}
\NormalTok{auto\_glm\_vi }\OtherTok{\textless{}{-}}\NormalTok{ AUTO\_GLM\_VI}\SpecialCharTok{$}\NormalTok{instantiate}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{set.seed}\NormalTok{(}\DecValTok{10086}\NormalTok{)}
...
\NormalTok{y\_fit }\OtherTok{\textless{}{-}} \FunctionTok{glm}\NormalTok{(y }\SpecialCharTok{\textasciitilde{}}\NormalTok{ x, }\AttributeTok{family =} \StringTok{"poisson"}\NormalTok{)}

\NormalTok{glm\_checker }\OtherTok{\textless{}{-}} \FunctionTok{auto\_glm\_vi}\NormalTok{(}\FunctionTok{glm}\NormalTok{(y }\SpecialCharTok{\textasciitilde{}}\NormalTok{ x, }\AttributeTok{family =} \StringTok{"poisson"}\NormalTok{),}
                           \AttributeTok{keras\_model =} \FunctionTok{get\_keras\_model}\NormalTok{(}\StringTok{"vss\_phn\_32"}\NormalTok{))}
\NormalTok{glm\_checker}\SpecialCharTok{$}\FunctionTok{plot\_lineup}\NormalTok{()}
\end{Highlighting}
\end{Shaded}

\begin{center}
\includegraphics[width=1\textwidth,height=\textheight]{autovi_paper_files/figure-pdf/unnamed-chunk-9-1.pdf}
\end{center}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{glm\_checker}\SpecialCharTok{$}\FunctionTok{check}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
