...
\hypersetup{
  pdftitle={Automated residual plot assessment with the R package  and the Shiny app },
...
\title{Automated residual plot assessment with the R package
\textsf{autovi} and the Shiny app \textsf{autovi.web}}
...
model widely accessible, we developed the R package \textsf{autovi}
along with a companion web interface, \textsf{autovi.web}, which allows
