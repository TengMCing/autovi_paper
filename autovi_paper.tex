...
\hypersetup{
  pdftitle={Automated residual plot assessment with the  package  and the  application },
...
visualisation, visual inference, computer vision, machine
...
\addressnum{2} Research School of Finance, Actuarial Studies and
Statistics, The Australian National University, CBE Building 26C,
Kingsley Street, ACT 2600, Australia\\
...
\includegraphics[width=1\textwidth,height=\textheight]{figures/autovi.pdf}
...
\includegraphics[width=1\textwidth,height=\textheight]{figures/autovi_web_setup.pdf}
...
\includegraphics[width=1\textwidth,height=\textheight]{figures/autovi_web_lineup.pdf}
...
\includegraphics[width=1\textwidth,height=\textheight]{figures/autovi_web_distributions.pdf}
